...
/** Extract resource type and optional ID from a URL path.
 *  /api/v1/lots/abc123  → { resourceType: 'lots', resourceId: 'abc123' }
 *  /api/v1/machines     → { resourceType: 'machines', resourceId: undefined }
 */
